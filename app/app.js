...
function viewVideo(video) {
  ...
  if (videoPlayer) {
    if (!video.video_url) {
      ...
      videoPlayer.src = video.video_url + '?v=' + Date.now(); // it should be without "?v" but Cache control tags dont work on video somehow, maybe try creating an separate endpoint for video?
      videoPlayer.load();
    }
  }
}
